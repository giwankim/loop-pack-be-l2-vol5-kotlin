 ...
 * 제약이 붙는 자리와 까닭은 [BrandRegisterRequest]와 같고(설계 5.18), 목록 입력을 제약으로 거르는 까닭은 설계 5.22에 있다.
 *
 * 상품 목록의 [com.loopers.application.product.ProductListRequest]와 같은 모양이다. 개념마다 Request를 따로 두어
