...
class ProductService(
    ...
    fun register(brandId: Long, name: String, price: Long, stock: Int): ProductInfo.Admin {
        val brand = brandRepository.find(brandId) ?: throw CoreException(ErrorType.BRAND_NOT_FOUND)
    ...
    fun getAdminProduct(id: Long): ProductInfo.Admin {
        val product = productRepository.find(id) ?: throw CoreException(ErrorType.PRODUCT_NOT_FOUND)
